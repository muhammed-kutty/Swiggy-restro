...
const Footer = () => {
  return (
    <footer className="bg-neutral-300 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p>
              ...
              work at Swiggy will help elevate the lives of our users across
              India.
            </p>
          </div>
